...
func _is_ally_targeting(ability_res: Resource) -> bool:
	...
	if "heal" in ability_name or "purr" in ability_name or "cure" in ability_name or "buff" in ability_name or "ammo" in ability_name or "craft" in ability_name:
		return true
	if "dart" in ability_name or "bolt" in ability_name or "fire" in ability_name or "claw" in ability_name or "slash" in ability_name:
		return false
